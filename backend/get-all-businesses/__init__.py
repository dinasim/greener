...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        query = "SELECT c.id, c.email, c.businessName, c.name, c.businessType, c.logo, c.address, c.rating, c.reviewCount FROM c WHERE c.status = 'active'"
        ...
        logging.info(f"Found {len(businesses)} active businesses")
        
        # Format businesses for marketplace
