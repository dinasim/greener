// OBSOLETE: Python implementation in __init__.py is active (FUNCTIONS_WORKER_RUNTIME=python).
// Keeping file only to signal deprecation.
...
module.exports = async function (context, req) {
  ...
  context.log('[register_device_token] incoming', {
    userId,
    email,
    provider,
    platform,
  ...
  try {
    ...
    context.log.error('[register_device_token] error', e);
