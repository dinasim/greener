...
const cityList = ['Acre', 'Afula', 'Arad', 'Arraba', 'Ashdod', 'Ashkelon', 'Baqa al-Gharbiyye', 'Bat Yam', 'Beersheba',
  ...
  export default function SignupLocationReq({ navigation }) {
    ...
    const handleCitySelect = async () => {
      ...
      console.log("📍 Selected city saved to context:", { city: selectedCity });
      ...
      // ✅ Delay navigation so that formData is saved before changing screen
      setTimeout(() => {
        navigation.navigate("SignupReminders");
      }, 300); // delay 300ms to let updateFormData propagate
    };
